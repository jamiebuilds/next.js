...
var WatchPagesPlugin = function () {
  ...
  (0, _createClass3.default)(WatchPagesPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      var errorPagePath = (0, _path.join)(__dirname, '..', '..', '..', 'pages', '_error.js');
      ...
      compiler.plugin('watch-run', function (watching, callback) {
        ...
        compiler.removedFiles.filter(isPageFile).forEach(function (f) {
          ...
          if (name === errorPageName) {
            compiler.addEntry([hotMiddlewareClientPath, errorPagePath], name);
          }
        });
    ...
    value: function isPageFile(f) {
      return f.indexOf(this.dir) === 0 && (0, _path.relative)(this.dir, f) !== '_document.js' && (0, _path.extname)(f) === '.js';
    }
  }]);
