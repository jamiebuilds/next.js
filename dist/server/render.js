          ...
          case 19:
            renderPage = function renderPage() {
              var app = (0, _react.createElement)(_app2.default, {
                Component: Component,
                props: props,
                router: new _router2.default(pathname, query)
              });
              var html = (staticMarkup ? _server.renderToStaticMarkup : _server.renderToString)(app);
              var head = _head2.default.rewind() || (0, _head.defaultHead)();
