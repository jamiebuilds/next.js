...
var _babel = require('./build/babel');
...
var HotReloader = function () {
  ...
  (0, _createClass3.default)(HotReloader, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _promise2.default.all([(0, _webpack2.default)(this.dir, { dev: true }), (0, _clean2.default)(this.dir)]);
              ...
              case 3:
                ...
                compiler = _ref4[0];
                _context3.next = 8;
                return _promise2.default.all([this.prepareMiddlewares(compiler), (0, _babel2.default)(this.dir, { dev: true })]);
    ...
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(compiler) {
        var _this3 = this;
      ...
      function prepareMiddlewares(_x3) {
    ...
    value: function watch() {
      ...
      var onChange = function onChange(path) {
        (0, _babel2.default)(_this5.dir, { dev: true }).then(function () {
          var f = (0, _path.join)(_this5.dir, '.next', 'dist', (0, _path.relative)(_this5.dir, path));
          delete require.cache[f];
          _this5.send('hardReload');
        });
      };

      this.watcher = (0, _babel.watch)(this.dir);
      this.watcher.on('add', onChange).on('change', onChange).on('unlink', onChange).on('error', function (err) {
        console.error(err);
      });
    }
  }]);
